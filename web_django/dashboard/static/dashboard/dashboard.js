...
async function actualizar() {
  try {
    ...
    // El Operador no recibe estas dos claves (son reportes agregados,
    // ver dashboard/views.py) -- sin este guard, intentar leer
    // datos.recaudacion.dia de undefined rompería el ciclo entero.
